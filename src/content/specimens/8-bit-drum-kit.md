...
specimenNumber: '06'
classification: Audio Instrument
habitat: Workshop drawer
firstObserved: '2026'
status: shipped
heroImage: /images/specimens/8-bit-drum-kit-hero.png
platform:
- web-audio
- sprite-animation
- 8-bit
...
- music
images: []
excerpt: An interactive drum kit with sprite animations - a nostalgic experiment in
