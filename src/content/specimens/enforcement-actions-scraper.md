...
specimenNumber: '09'
classification: Compliance Intelligence Pipeline
habitat: Internal API · 23 sources, 16 jurisdictions
firstObserved: '2026'
status: in-progress
heroImage: /images/specimens/enforcement-actions-scraper-hero.png
platform:
- scraping
- node.js
- postgresql
