...
specimenNumber: '12'
classification: Community Lending App
habitat: Private — Toronto townhouse complex
firstObserved: '2025'
status: dormant
heroImage: /images/specimens/edgewood-library-hero.png
platform:
- community
- sharing-economy
- nextjs
...
- local-first
images: []
excerpt: A community tool-sharing app for neighbors - because that circular saw shouldn't
  gather dust for another 5 years
---
