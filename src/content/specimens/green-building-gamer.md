...
specimenNumber: '04'
classification: Gamified Certification Training
habitat: Web — Gulf Region pilot
firstObserved: '2026'
status: active
heroImage: /images/specimens/green-building-gamer-hero.png
platform:
- game
- education
- gamification
...
- collaboration
images: []
excerpt: A gamified certification prep app for Gulf region green building professionals
  - LEED, Mostadam, and the first serious tooling for regional standards
url: https://green-building-gamer.vercel.app
---
