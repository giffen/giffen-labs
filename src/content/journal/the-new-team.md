...
date: '2026-02-18'
excerpt: 'The old model was clear: PMs write tickets, designers make mocks, engineers
  build, QA tests. One PM to five or eight engineers. That ratio made sense when code
  was the bottleneck. It doesn''t make sense when code is automated. Here''s what
  the new team looks like.'
---
