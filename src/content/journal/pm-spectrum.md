---
title: What's Your New Shape? The PM Competency Model for the AI Era
date: '2026-02-26'
excerpt: For years, I've used Ravi Mehta's 'What's Your Shape?' framework to assess
  myself, explain what a PM does to non-PMs, and evaluate PMs on my team. It's the
  best PM competency model ever created. But AI just collapsed half the chart. Here's
  what replaces it.
---

## The Framework That Shaped My Career

For years, Ravi Mehta's ["What's Your Shape?"](https://www.ravi-mehta.com/product-manager-roles/) has been my most-used PM framework. Not the most-cited — that's probably some variation of "jobs to be done." But the most *used*, in three very concrete ways:
...
<figure>
  <img src="/images/writing/pm-spectrum-framework.svg" alt="The AI-era PM competency framework with four axes: Customer Closeness, Strategic Direction, Technical Building, and Organizational Influence" />
  <figcaption>The AI-era PM framework: four axes replacing twelve competencies.</figcaption>
</figure>
...
I [built Brown Note](/writing/building-brown-note) — a full mobile app with a Django backend, REST API, push notifications, and cross-platform deployment — in three weeks for $350. I'm not an engineer. I'm a PM who learned to direct AI tools effectively. That's Technical Building.

Kim Faura [reports](https://www.linkedin.com/pulse/three-finger-kim-what-happened-when-i-stopped-typing-started-faura-yense) a PM who refactored 80% of a front-end in four days. Engineers had estimated four months. Boris Cherny at Anthropic deliberately underfunds headcount to force AI adoption. The PM who can ship a prototype themselves collapses the entire handoff chain from idea to validation.
...
<figure>
  <img src="/images/writing/pm-spectrum-archetypes.svg" alt="Three PM archetypes plotted on the new framework: The Builder (high Technical Building and Customer Closeness), The Strategist (high Strategic Direction and Organizational Influence), and The Danger Zone (moderate across all axes)" />
  <figcaption>Three shapes on the new framework. The edges are where value concentrates.</figcaption>
</figure>
...
Ravi Mehta built the best PM competency framework of the past decade. What I've outlined here isn't a replacement — it's an evolution, driven by the same forces that are [reshaping product teams](/writing/the-new-team) and [redefining what's automatable](/writing/how-much-can-we-automate).
