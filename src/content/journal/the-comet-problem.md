...
date: '2026-02-18'
excerpt: There's a moment in Halt and Catch Fire where the Comet team is working around
  the clock, cataloging the internet by hand, making real progress on a real product.
  And then search arrives and none of it matters. That's happening right now across
  the industry. But unlike the show, I think this time the shift is something to run
  toward.
---
